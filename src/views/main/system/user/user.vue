<template>
  <div class="user">
    ...
    ></page-content>
    <page-modal :defaultValue="defaultValue" ref="pageModalRef" :modal-config="modalConfigRef" pageName="users" ></page-modal>
  </div>
</template>
...
const [pageModalRef,defaultValue,newBtnClick,editBtnClick] = useModal(newCallback,editCallback)
